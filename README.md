# REPOSITORY NAME: Mongodb_CRUD_Checkpoint

# DESCRIPTION: A repository with screenshots that display MongoDB CRUD operations. Below is the objective of this checkpoint and repo, and instructions carried out to achieve the objective.
